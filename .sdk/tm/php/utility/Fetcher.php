...
// Phantomjscloud SDK utility: fetcher

class PhantomjscloudFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PhantomjscloudSDK/1.0)';
    ...
    public static function call(PhantomjscloudContext $ctx, string $fullurl, array $fetchdef): array
    {
