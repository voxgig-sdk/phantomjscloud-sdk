...
// Phantomjscloud SDK utility: make_options

class PhantomjscloudMakeOptions
{
    ...
    public static function call(PhantomjscloudContext $ctx): array
    {
        ...
        //
        // `PhantomjscloudSchema::optspec()` is built from the model:
        ...
        $optspec = PhantomjscloudSchema::optspec();
