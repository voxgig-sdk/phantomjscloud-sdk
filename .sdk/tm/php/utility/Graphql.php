...
// Phantomjscloud SDK utility: graphql
//
...
class PhantomjscloudGraphql
{
    ...
    // equivalent.
    public static function body(PhantomjscloudContext $ctx): mixed
    {
    ...
    public static function errors(PhantomjscloudContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
