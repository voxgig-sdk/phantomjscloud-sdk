...
// Phantomjscloud SDK clienttrack feature
...
class PhantomjscloudClienttrackFeature extends PhantomjscloudBaseFeature
{
    ...
    public function PostConstruct(PhantomjscloudContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Phantomjscloud-SDK';
