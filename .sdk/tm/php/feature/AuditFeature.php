...
// Phantomjscloud SDK audit feature
...
class PhantomjscloudAuditFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _emit(PhantomjscloudContext $ctx, string $outcome): void
    {
