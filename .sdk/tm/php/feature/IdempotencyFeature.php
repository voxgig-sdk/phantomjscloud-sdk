...
// Phantomjscloud SDK idempotency feature
...
class PhantomjscloudIdempotencyFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _mutating(PhantomjscloudContext $ctx): bool
    {
