...
// Phantomjscloud SDK streaming feature
...
class PhantomjscloudStreamingFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _iterate(PhantomjscloudResult $result): \Generator
    {
    ...
    private function _streamable(PhantomjscloudContext $ctx): bool
    {
