...
// Phantomjscloud SDK proxy feature
...
class PhantomjscloudProxyFeature extends PhantomjscloudBaseFeature
{
    ...
    public function init(PhantomjscloudContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PhantomjscloudContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
