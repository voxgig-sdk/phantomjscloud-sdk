...
// Phantomjscloud SDK rbac feature
...
class PhantomjscloudRbacFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _required(PhantomjscloudContext $ctx): ?string
    {
    ...
    private function _reject(PhantomjscloudContext $ctx, string $required): void
    {
    ...
    private function _track(PhantomjscloudContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
