...
// Phantomjscloud SDK telemetry feature
...
class PhantomjscloudTelemetryFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _close(PhantomjscloudContext $ctx, bool $ok): void
    {
