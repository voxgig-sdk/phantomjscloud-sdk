...
// Phantomjscloud SDK pipeline test
//
...
{
    private static function utility(): PhantomjscloudUtility
    {
        return new PhantomjscloudUtility();
    }
    ...
    private static function ctx(array $over = []): PhantomjscloudContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PhantomjscloudContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PhantomjscloudOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PhantomjscloudError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PhantomjscloudOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PhantomjscloudMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PhantomjscloudOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PhantomjscloudMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PhantomjscloudOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PhantomjscloudMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PhantomjscloudSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PhantomjscloudMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PhantomjscloudResponse([]),
            'result' => new PhantomjscloudResult([]),
        ]);
        [, $err] = PhantomjscloudMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PhantomjscloudSpec([]),
            'response' => null,
            'result' => new PhantomjscloudResult([]),
        ]);
        [, $err] = PhantomjscloudMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PhantomjscloudSpec(['step' => 's']),
            'response' => new PhantomjscloudResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PhantomjscloudResult([]),
        ]);
        [, $err] = PhantomjscloudMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PhantomjscloudSpec(['step' => 's']),
            'response' => new PhantomjscloudResponse(self::resp(200, ['v' => 1])),
            'result' => new PhantomjscloudResult([]),
        ]);
        [, $err] = PhantomjscloudMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PhantomjscloudSpec(['step' => 's']),
            'response' => new PhantomjscloudResponse(self::resp(200, ['v' => 2])),
            'result' => new PhantomjscloudResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PhantomjscloudMakeResponse::call($ctx);
    ...
    {
        $preset = new PhantomjscloudResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PhantomjscloudSpec([]),
            'response' => new PhantomjscloudResponse([]),
            'result' => new PhantomjscloudResult([]),
        ...
        [$got, $err] = PhantomjscloudMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PhantomjscloudResult([])]);
        [, $err] = PhantomjscloudMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PhantomjscloudSpec([]), 'result' => null]);
        [, $err] = PhantomjscloudMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PhantomjscloudSpec(['step' => 's']),
            'result' => new PhantomjscloudResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PhantomjscloudOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PhantomjscloudMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PhantomjscloudSpec(['step' => 's']),
            'result' => new PhantomjscloudResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PhantomjscloudOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PhantomjscloudMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PhantomjscloudResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PhantomjscloudSpec([]),
            'result' => new PhantomjscloudResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PhantomjscloudMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PhantomjscloudMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PhantomjscloudError('boom', 'boom');
        $utility->fetcher = function (PhantomjscloudContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PhantomjscloudSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PhantomjscloudMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PhantomjscloudContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PhantomjscloudMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PhantomjscloudResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        PhantomjscloudMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PhantomjscloudContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PhantomjscloudSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PhantomjscloudMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PhantomjscloudResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PhantomjscloudSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PhantomjscloudMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PhantomjscloudMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PhantomjscloudMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PhantomjscloudResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PhantomjscloudDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PhantomjscloudResult(['ok' => false])]);
        $this->expectException(PhantomjscloudError::class);
        PhantomjscloudDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PhantomjscloudResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PhantomjscloudMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PhantomjscloudMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PhantomjscloudBaseFeature();
        $b = new PhantomjscloudBaseFeature();
        PhantomjscloudFeatureAdd::call($ctx, $a);
        PhantomjscloudFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PhantomjscloudBaseFeature
    {
        $f = new PhantomjscloudBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PhantomjscloudFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PhantomjscloudContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PhantomjscloudSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PhantomjscloudPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        PhantomjscloudPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PhantomjscloudResponse(['headers' => null]),
            'result' => new PhantomjscloudResult([]),
        ]);
        PhantomjscloudResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        PhantomjscloudResultBody::call($ctx);
