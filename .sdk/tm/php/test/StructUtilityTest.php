...
// Phantomjscloud SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PhantomjscloudOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PhantomjscloudOmni::structfix($now, Struct::undef()))
                        !== json_encode(PhantomjscloudOmni::structfix($val, Struct::undef()))) {
