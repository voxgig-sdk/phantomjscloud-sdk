...
|---|---|---|
| `ts/` | @voxgig-sdk/phantomjscloud-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/phantomjscloud-sdk \
      --repository voxgig-sdk/phantomjscloud-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/phantomjscloud-sdk` shows it, and
`npm trust revoke @voxgig-sdk/phantomjscloud-sdk --id=<id>` removes it.
