// Command Phantomjscloud-mcp is an MCP server exposing the Phantomjscloud
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Phantomjscloud_list  — list records of an entity
//	Phantomjscloud_load  — load a single record of an entity
//
