...
type Args struct {
	Entity string         `json:"entity" jsonschema:"render_page_get | render_page_post"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PhantomjscloudSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "phantomjscloud_list",
		Description: "List records from Phantomjscloud. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "phantomjscloud_load",
		Description: "Load a single record from Phantomjscloud. " +
...
func runOp(client *sdk.PhantomjscloudSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PhantomjscloudSDK, name string) (sdk.PhantomjscloudEntity, error) {
	switch strings.ToLower(name) {
	case "render_page_get":
		return client.RenderPageGet(nil), nil
	case "render_page_post":
		return client.RenderPagePost(nil), nil
