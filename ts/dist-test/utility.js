...
function envOverride(m) {
    if ('TRUE' === process.env.PHANTOMJSCLOUD_TEST_LIVE ||
        'TRUE' === process.env.PHANTOMJSCLOUD_TEST_OVERRIDE) {
    ...
    m.PHANTOMJSCLOUD_TEST_EXPLAIN = process.env.PHANTOMJSCLOUD_TEST_EXPLAIN || m.PHANTOMJSCLOUD_TEST_EXPLAIN;
    return m;
}
