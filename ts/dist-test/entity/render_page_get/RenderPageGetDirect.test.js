...
(0, node_test_1.describe)('RenderPageGetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PhantomjscloudSDK({
    ...
    (0, node_test_1.test)('direct-load-render_page_get', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-render_page_get', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PHANTOMJSCLOUD_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PhantomjscloudSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.PHANTOMJSCLOUD_APIKEY,
        }));
        let idmap = env['PHANTOMJSCLOUD_TEST_RENDER_PAGE_GET_ENTID'];
    ...
    const client = new __1.PhantomjscloudSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RenderPageGetDirect.test.js.map