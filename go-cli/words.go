...
func registerSDKWords(r *eng.Registry, client *sdk.PhantomjscloudSDK) {
...
func runOp(client *sdk.PhantomjscloudSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
