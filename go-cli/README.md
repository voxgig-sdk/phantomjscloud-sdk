...
AQL-driven CLI and REPL for the Phantomjscloud SDK. Positional arguments are
...
./phantomjscloud-cli list render_page_get
./phantomjscloud-cli load 1 render_page_get
./phantomjscloud-cli load '{id:1}' render_page_get
