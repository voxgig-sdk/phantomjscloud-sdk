...
Results: Successful page render.
...
| --- | --- | --- | --- |
| RenderPageGet | `load` | `GET /{apiKey}/` | Required |
| RenderPagePost | `create` | `POST /{apiKey}/` | Required |

## Connect to the API

- PhantomJsCloud API Server: `https://phantomjscloud.com/api/browser/v2`

The default credential is sent in the `apiKey` path.

API key for authentication. Obtain from Dashboard.PhantomJsCloud.com. Demo key: &#39;a-demo-key-with-low-quota-per-ip-address&#39; (100 requests/day limit)
...
- `phantomjscloud_list`: List records for an entity. No active entity supports this operation.
- `phantomjscloud_load`: Load one record for an entity. Supported entities: `render_page_get`.
