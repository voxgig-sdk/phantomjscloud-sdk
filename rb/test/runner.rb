...
module PhantomjscloudTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("PHANTOMJSCLOUD_TEST_LIVE")
    override = getenv("PHANTOMJSCLOUD_TEST_OVERRIDE")
    ...
    explain = getenv("PHANTOMJSCLOUD_TEST_EXPLAIN")
    m["PHANTOMJSCLOUD_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PhantomjscloudTestRunner
Helpers = PhantomjscloudHelpers
Vs = VoxgigStruct
