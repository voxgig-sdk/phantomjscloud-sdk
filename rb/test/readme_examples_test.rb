...
#      offline in seeded test mode (PhantomjscloudSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Phantomjscloud_sdk.rb")
  SDK_CLASS = "PhantomjscloudSDK"
