...
from phantomjscloud_sdk.core.helpers import get_ctx_prop, to_map
...
class PhantomjscloudContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PhantomjscloudControl()
        ...
        if isinstance(sp, PhantomjscloudSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PhantomjscloudResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PhantomjscloudResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PhantomjscloudOperation({})
    ...
    def make_error(self, code, msg):
        return PhantomjscloudError(code, msg, self)
