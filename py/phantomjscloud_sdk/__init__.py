...
from phantomjscloud_sdk.utility import register

# Load features
from phantomjscloud_sdk.feature.base_feature import PhantomjscloudBaseFeature
from phantomjscloud_sdk.features import _has_feature, _make_feature
...
class PhantomjscloudSDK:
    ...
    def get_utility(self):
        return PhantomjscloudUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PhantomjscloudSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def RenderPageGet(self, data=None) -> "RenderPageGetEntity":
        ...
        from phantomjscloud_sdk.entity.render_page_get_entity import RenderPageGetEntity
    ...
    def RenderPagePost(self, data=None) -> "RenderPagePostEntity":
        ...
        from phantomjscloud_sdk.entity.render_page_post_entity import RenderPagePostEntity
