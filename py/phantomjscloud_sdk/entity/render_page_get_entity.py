...
from phantomjscloud_sdk.phantomjscloud_types import (
    RenderPageGet,
...
class RenderPageGetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RenderPageGetEntity(self._client, opts)
    ...
    def data_get(self) -> RenderPageGet:
    ...
    def match_get(self) -> RenderPageGet:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RenderPageGet:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RenderPageGet().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
