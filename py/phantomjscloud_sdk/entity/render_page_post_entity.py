...
class RenderPagePostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RenderPagePostEntity(self._client, opts)
    ...
    def data_get(self) -> RenderPagePost:
    ...
    def match_get(self) -> RenderPagePost:
    ...
    def create(self, reqdata: RenderPagePostCreateData, ctrl=None) -> RenderPagePost:
        utility = self._utility
