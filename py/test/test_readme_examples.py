# Phantomjscloud SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PhantomjscloudSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PhantomjscloudSDK(...) and PhantomjscloudSDK.test(...) become
#      PhantomjscloudSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "phantomjscloud_sdk"
_SDK_CLASS = "PhantomjscloudSDK"
...
_ENTITIES = {
    "RenderPageGet": "render_page_get",
    "RenderPagePost": "render_page_post",
}
