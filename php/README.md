# Phantomjscloud PHP SDK

The PHP SDK for the Phantomjscloud API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->RenderPageGet(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Phantomjscloud(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── phantomjscloud_sdk.php          -- Main SDK class
...
The main class (`phantomjscloud_sdk.php`) exports the SDK class
