...
// Phantomjscloud SDK RenderPagePost entity
...
class RenderPagePostEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RenderPagePostEntity($this->_client, $opts);
    }

    /**
     * @param RenderPagePost|array $args RenderPagePost data (assoc-array) to store.
     */
    ...
    /**
     * @return RenderPagePost|array The current RenderPagePost data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RenderPagePost fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RenderPagePost fields).
     */
    ...
    /**
     * Create a new RenderPagePost.
     *
     * @param RenderPagePostCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RenderPagePostCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RenderPagePost|array The created RenderPagePost as an assoc-array at the
