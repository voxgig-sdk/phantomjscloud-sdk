...
// Phantomjscloud SDK cache feature
...
class PhantomjscloudCacheFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _through(PhantomjscloudContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
