...
// Phantomjscloud SDK timeout feature
...
class PhantomjscloudTimeoutFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _with_timeout(PhantomjscloudContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PhantomjscloudContext $_ctx, float $ms): void
    {
        $client = $this->client;
