...
// Phantomjscloud SDK ratelimit feature
...
class PhantomjscloudRatelimitFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _acquire(PhantomjscloudContext $ctx): void
    {
    ...
    private function _track(PhantomjscloudContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
