...
// Phantomjscloud SDK metrics feature
...
class PhantomjscloudMetricsFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _record(PhantomjscloudContext $ctx, bool $ok): void
    {
