...
// Phantomjscloud SDK netsim feature
...
class PhantomjscloudNetsimFeature extends PhantomjscloudBaseFeature
{
    ...
    private function _simulate(PhantomjscloudContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PhantomjscloudContext $ctx, array $applied): void
    {
        $client = $this->client;
