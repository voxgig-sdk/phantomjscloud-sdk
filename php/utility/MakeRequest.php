...
// Phantomjscloud SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PhantomjscloudMakeRequest
{
    public static function call(PhantomjscloudContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PhantomjscloudResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PhantomjscloudResponse($fetched);
        } else {
