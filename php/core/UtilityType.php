...
// Phantomjscloud SDK utility type

class PhantomjscloudUtility
{
    ...
    public static function copy(PhantomjscloudUtility $src): PhantomjscloudUtility
    {
        $u = new PhantomjscloudUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
