...
class PhantomjscloudTestRunner
{
    ...
    {
        $live = self::getenv('PHANTOMJSCLOUD_TEST_LIVE');
        $override = self::getenv('PHANTOMJSCLOUD_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PHANTOMJSCLOUD_TEST_EXPLAIN');
...
class_alias('PhantomjscloudTestRunner', 'Runner');
class_alias('PhantomjscloudHelpers', 'Helpers');
