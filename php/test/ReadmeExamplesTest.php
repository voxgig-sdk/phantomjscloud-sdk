...
// Phantomjscloud SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PhantomjscloudSDK::test)
...
{
    private const SDK_CLASS = 'PhantomjscloudSDK';
    ...
    private const SDK_BASE = 'phantomjscloud_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../phantomjscloud_sdk.php';
