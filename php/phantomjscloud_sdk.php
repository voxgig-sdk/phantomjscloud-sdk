...
class PhantomjscloudSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = PhantomjscloudHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = PhantomjscloudHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!PhantomjscloudFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, PhantomjscloudFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return PhantomjscloudUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = PhantomjscloudHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = PhantomjscloudHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = PhantomjscloudHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new PhantomjscloudError($op . "_allow",
                "PhantomjscloudSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = PhantomjscloudHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new PhantomjscloudError("graphql_error",
                "PhantomjscloudSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function RenderPageGet($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_render_page_get === null) {
                $this->_render_page_get = new RenderPageGetEntity($this, null);
            }
            return $this->_render_page_get;
        }
        return new RenderPageGetEntity($this, $data);
    }
    ...
    public function RenderPagePost($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_render_page_post === null) {
                $this->_render_page_post = new RenderPagePostEntity($this, null);
            }
            return $this->_render_page_post;
        }
        return new RenderPagePostEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new PhantomjscloudSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
