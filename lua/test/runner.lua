...
function runner.env_override(m)
  local live = runner.getenv("PHANTOMJSCLOUD_TEST_LIVE")
  local override = runner.getenv("PHANTOMJSCLOUD_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PHANTOMJSCLOUD_TEST_EXPLAIN")
