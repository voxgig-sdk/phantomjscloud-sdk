...
local RenderPageGetEntity = {}
RenderPageGetEntity.__index = RenderPageGetEntity


function RenderPageGetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RenderPageGetEntity)
  self._name = "render_page_get"
  self._client = client
...
function RenderPageGetEntity:get_name()
  return self._name
end


function RenderPageGetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RenderPageGetEntity.new(self._client, opts)
end
...
function RenderPageGetEntity:mark_deleted()
  self._deleted = true
end


function RenderPageGetEntity:deleted()
  return true == self._deleted
end


function RenderPageGetEntity:data_set(args)
  if args ~= nil then
...
function RenderPageGetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RenderPageGetEntity:match_set(args)
  if args ~= nil then
...
function RenderPageGetEntity:match_get()
...
function RenderPageGetEntity:stream(action, args, callopts)
...
---@param reqmatch RenderPageGetLoadMatch
---@param ctrl? table
---@return RenderPageGet
---@return string? err
function RenderPageGetEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RenderPageGetEntity:_run_op(ctx, post_done)
  local utility = self._utility
