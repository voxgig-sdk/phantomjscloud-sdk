...
func NewRenderPageGetEntity(client *core.PhantomjscloudSDK, entopts map[string]any) *RenderPageGetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RenderPageGetEntity) GetName() string { return e.name }
...
func (e *RenderPageGetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RenderPageGetEntity) Deleted() bool {
	return e.deleted
}


func (e *RenderPageGetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRenderPageGetEntity(e.client, opts)
}

func (e *RenderPageGetEntity) Data(args ...any) any {
...
func (e *RenderPageGetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RenderPageGet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RenderPageGetEntity) DataTyped(data ...RenderPageGet) RenderPageGet {
	if len(data) > 0 {
		return typedFrom[RenderPageGet](e.Data(asMap(data[0])))
	}
	return typedFrom[RenderPageGet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RenderPageGet (all fields
// optional at the wire level).
func (e *RenderPageGetEntity) MatchTyped(match ...RenderPageGet) RenderPageGet {
	if len(match) > 0 {
		return typedFrom[RenderPageGet](e.Match(asMap(match[0])))
	}
	return typedFrom[RenderPageGet](e.Match())
}
...
func (e *RenderPageGetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RenderPageGetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RenderPageGetLoadMatch and returns an RenderPageGet. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RenderPageGetEntity) LoadTyped(reqmatch RenderPageGetLoadMatch, ctrl map[string]any) (RenderPageGet, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RenderPageGet{}, err
	}
	return typedFrom[RenderPageGet](res), nil
}



func (e *RenderPageGetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RenderPageGetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RenderPageGetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RenderPageGetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RenderPageGetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
