...
type RenderPagePostEntity struct {
	name    string
	client  *core.PhantomjscloudSDK
...
func NewRenderPagePostEntity(client *core.PhantomjscloudSDK, entopts map[string]any) *RenderPagePostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RenderPagePostEntity) GetName() string { return e.name }
...
func (e *RenderPagePostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RenderPagePostEntity) Deleted() bool {
	return e.deleted
}


func (e *RenderPagePostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRenderPagePostEntity(e.client, opts)
}

func (e *RenderPagePostEntity) Data(args ...any) any {
...
func (e *RenderPagePostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RenderPagePost; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RenderPagePostEntity) DataTyped(data ...RenderPagePost) RenderPagePost {
	if len(data) > 0 {
		return typedFrom[RenderPagePost](e.Data(asMap(data[0])))
	}
	return typedFrom[RenderPagePost](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RenderPagePost (all fields
// optional at the wire level).
func (e *RenderPagePostEntity) MatchTyped(match ...RenderPagePost) RenderPagePost {
	if len(match) > 0 {
		return typedFrom[RenderPagePost](e.Match(asMap(match[0])))
	}
	return typedFrom[RenderPagePost](e.Match())
}
...
func (e *RenderPagePostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RenderPagePostEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RenderPagePostEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RenderPagePostEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RenderPagePostCreateData and returns an RenderPagePost. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RenderPagePostEntity) CreateTyped(reqdata RenderPagePostCreateData, ctrl map[string]any) (RenderPagePost, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return RenderPagePost{}, err
	}
	return typedFrom[RenderPagePost](res), nil
}



func (e *RenderPagePostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RenderPagePostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RenderPagePostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
