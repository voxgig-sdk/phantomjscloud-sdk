...
func (sdk *PhantomjscloudSDK) OptionsMap() map[string]any {
...
func (sdk *PhantomjscloudSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PhantomjscloudSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PhantomjscloudSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PhantomjscloudSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PhantomjscloudSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PhantomjscloudSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PhantomjscloudSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PhantomjscloudSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PhantomjscloudSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PhantomjscloudSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *PhantomjscloudSDK {
	...
	sdk := NewPhantomjscloudSDK(sdkopts)
	sdk.Mode = "test"
