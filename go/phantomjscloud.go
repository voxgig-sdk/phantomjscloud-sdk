...
// instead of `sdk.NewPhantomjscloudSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *PhantomjscloudSDK  { return NewPhantomjscloudSDK(nil) }
func Test() *PhantomjscloudSDK { return TestSDK(nil, nil) }
