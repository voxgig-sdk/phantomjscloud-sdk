...
const testSeed = `map[string]any{"entity": map[string]any{"render_page_get": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "render_page_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
