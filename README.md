...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/phantomjscloud` | `npm install @voxgig-sdk/phantomjscloud` |
| Python | `voxgig-sdk-phantomjscloud` | `pip install voxgig-sdk-phantomjscloud` |
| PHP | `voxgig-sdk/phantomjscloud` | `composer require voxgig-sdk/phantomjscloud` |
| Golang | `github.com/voxgig-sdk/phantomjscloud-sdk/go` | `go get github.com/voxgig-sdk/phantomjscloud-sdk/go` |
| Ruby | `voxgig-sdk-phantomjscloud` | `gem install voxgig-sdk-phantomjscloud` |
| Lua | `voxgig-sdk-phantomjscloud` | `luarocks install voxgig-sdk-phantomjscloud` |
